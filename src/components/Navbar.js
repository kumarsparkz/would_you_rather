                    ...
                    <div className="collapse navbar-collapse">
                        <ul className="navbar-nav">
                            ...
                            <NavLink to='/add' exact activeClassName='active'
                                     className="nav-item nav-link">Create a new poll</NavLink>
                            <NavLink to='/leaderboard' exact activeClassName='active'
                                     className="nav-item nav-link">Leaderboard</NavLink>
                        </ul>

                        <span
                            className="navbar-text margin-left-100 margin-right-25 text-info color=#969696">Welcome {loggedInUser.loggedInUser.name}</span>
